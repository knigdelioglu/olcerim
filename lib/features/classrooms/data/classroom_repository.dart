...
class ClassroomRepository {
  ...
  Future<int> createClassroom({required int schoolYearId, required String name, required String courseName, String? description}) {
    return _dao.saveClassroom(schoolYearId: schoolYearId, name: name, courseName: courseName, description: description);
  }

  Future<int> updateClassroom({required int id, required int schoolYearId, required String name, required String courseName, String? description}) {
    return _dao.saveClassroom(id: id, schoolYearId: schoolYearId, name: name, courseName: courseName, description: description);
  }
